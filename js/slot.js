...
var SLOT_SPEED = 12; // how many pixels per second slots roll
...
Game.prototype.update = function() {
	...
	$('#results').show();
	if (that.items2[that.result2].id == that.items1[that.result1].id) {
	    ec++;
		if (that.items3[that.result3].id == that.items1[that.result1].id) {
			ec++;
		}
	}
	$('#multiplier').text(ec);
